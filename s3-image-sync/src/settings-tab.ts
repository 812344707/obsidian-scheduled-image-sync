...
export class S3ImageSyncSettingTab extends PluginSettingTab {
  ...
  private renderSettings(): void {
    ...
    new Setting(containerEl)
      .setName(t("cleanupTitle"))
      .setDesc(t("cleanupSettingsDesc"))
      .addButton(button => button.setButtonText(t("cleanupScan")).onClick(() => this.plugin.openImageCleanup()));
